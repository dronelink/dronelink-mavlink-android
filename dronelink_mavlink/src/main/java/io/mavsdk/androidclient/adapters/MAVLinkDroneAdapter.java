...
public class MAVLinkDroneAdapter implements DroneAdapter {
    ...
    public MAVLinkDroneAdapter(System drone) {
        this.drone = drone;
    }
...
//    }
    ...
    public RemoteControllerAdapter getRemoteController(final int channel) {
        ...
        if (remoteControllerAdapter == null && channel < 1) {
            final ManualControl remoteController = drone.getManualControl();
            if (remoteController != null) {
                return remoteControllers.put(channel, new MAVLinkRemoteControllerAdapter(remoteController));
            }
        }
    ...
    public void sendVelocityCommand(final VelocityDroneCommand velocityCommand) {
        ...
        previousVelocityCommandMillis = java.lang.System.currentTimeMillis();
    ...
    private boolean ignoreVelocityCommand() {
        if (drone.getModel() != null) {
            switch (drone.getModel()) {
                ...
                case PHANTOM_4_RTK:
                    return java.lang.System.currentTimeMillis() - previousVelocityCommandMillis < 150;
                default:
                    break;
            }
        }
