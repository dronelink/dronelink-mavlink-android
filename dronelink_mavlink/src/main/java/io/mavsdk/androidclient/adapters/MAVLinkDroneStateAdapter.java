...
//    public DatedValue<OcuSyncFrequencyBand> ocuSyncFrequencyBand;
    ...
    public MAVLinkDroneStateAdapter(final Context context, final System drone) {
...
//        return new DatedValue<>(this, new Date());
    ...
    public List<Message> getStatusMessages() {
        ...
        if (compassState != null && compassState.value != null) {
            final Message message = DronelinkMAVLink.getMessage(context, compassState.value.getSensorState());
            if (message != null) {
    ...
    public Message getCompassCalibrationMessage() {
        ...
        if (flightController != null) {
            final Compass compass = flightController.getCompass();
            if (compass != null) {
                return DronelinkMAVLink.getMessage(context, compass.getCalibrationState());
            }
        }
        return null;
    }
    ...
    public Location getLocation() {
        ...
        return DronelinkMAVLink.getLocation(aircraftLocation);
    }
    ...
    public Location getHomeLocation() {
        ...
        return DronelinkMAVLink.getLocation(homeLocation);
    }
    ...
    public Double getGPSSignalStrength() {
        final DatedValue<System> flightControllerState = this.flightControllerState;
        return flightControllerState == null ? null : DronelinkMAVLink.getGPSSignalValue(flightControllerState.value.getTelemetry().getGpsInfo());
    }
...
//        return lightbridgeFrequencyBand == null ? null : DronelinkMAVLink.getLightbridgeFrequencyBand(lightbridgeFrequencyBand.value);
//    }
//
//    @Override
//    public DroneOcuSyncFrequencyBand getOcuSyncFrequencyBand() {
//        return ocuSyncFrequencyBand == null ? null : DronelinkMAVLink.getOcuSyncFrequencyBand(ocuSyncFrequencyBand.value);
//    }
