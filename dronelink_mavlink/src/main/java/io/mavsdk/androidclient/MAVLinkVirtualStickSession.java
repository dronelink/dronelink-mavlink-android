...
public class MAVLinkVirtualStickSession implements DroneControlSession {
    private static final String TAG = MAVLinkVirtualStickSession.class.getCanonicalName();
    ...
    private final MAVLinkDroneSession droneSession;
    ...
    public MAVLinkVirtualStickSession(final Context context, final MAVLinkDroneSession droneSession) {
